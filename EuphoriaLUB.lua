...
function lib:Window(text, preset, closebind)
    ...
    TabHold.Size = UDim2.new(0, 107, 0, 150)
    ...
    TabHoldLayout.Padding = UDim.new(0, 11)
      ...
      Pong.Name = "Pong"
      Pong.Parent = DragFrame
      Pong.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
      Pong.BackgroundTransparency = 1.000
      Pong.Position = UDim2.new(0, 16, 0, 2)
      Pong.Size = UDim2.new(0, 200, 0, 23)
      Pong.Font = Enum.Font.GothamSemibold
      Pong.Text = "•"
      Pong.TextColor3 = Color3.fromRGB(0, 190, 255)
      Pong.TextSize = 30.000
      Pong.TextXAlignment = Enum.TextXAlignment.Left
   
      Ping.Name = "Ping"
      Ping.Parent = DragFrame
      Ping.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
      Ping.BackgroundTransparency = 1.000
      Ping.Position = UDim2.new(0, 26, 0, 2)
      Ping.Size = UDim2.new(0, 200, 0, 23)
      Ping.Font = Enum.Font.GothamSemibold
      Ping.Text = "•"
      Ping.TextColor3 = Color3.fromRGB(20, 255, 150)
   ...
   DragFrame.Size = UDim2.new(0, 560, 0, 30)
    ...
    function tabhold:Tab(text)
        ...
        function tabcontent:Dropdown(text, list, callback)
           ...
           local isdropping = false
            ...
            DropButton2.MouseButton1Click:Connect(
                function()
                    if droptog == false then
                        Dropdown:TweenSize(
                            UDim2.new(0, 363, 0, 55 + framesize),
        ...
        function tabcontent:Colorpicker(text, preset, callback)
            ...
            FrameRainbowToggle3.BackgroundColor3 = Color3.fromRGB(40,40,40)
        ...
        function labell:Set(newtext)
         ...
         function tabcontent: Separator(text)
            ...
            SepTitle.Text = text
            SepTitle.TextColor3 = Color3.fromRGB(255, 255, 255)
            ...
            SepLeft.Text = "———————"
            SepLeft.TextColor3 = Color3.fromRGB(25, 255, 190)
            ...
            SepRight.Text = "———————"
            SepRight.TextColor3 = Color3.fromRGB(25, 255, 190)
