...
function lib:Window(text, preset, closebind)
   ...
   DragFrame.Size = UDim2.new(0, 320, 0, 30)
   ...
   Pord.Position = UDim2.new(0, 10, 0, 215)
   ...
   Key.BackgroundTransparency = 0.000
   Key.Position = UDim2.new(0, 200, 0, 215)
   Key.Size = UDim2.new(0, 110, 0, 25)
   Key.Font = Enum.Font.Code
   Key.Text = "No Key Entered"
   Key.TextColor3 = Color3.fromRGB(190, 190, 190)
   Key.TextSize = 10.000
...
game:GetService("CoreGui"):FindFirstChild("key"):Destroy()
    ...
    function lib:Notification(texttitle, textdesc, textbtn)
        ...
        NotificationHold.Size = UDim2.new(0, 320, 0, 250)
        ...
        NotificationFrame.Position = UDim2.new(0, 160, 0, 120)
